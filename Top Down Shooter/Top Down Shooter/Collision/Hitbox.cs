...
namespace Top_Down_Shooter
{
    ...
    public class Hitbox
    {
        ...
        {
            spriteBatch.Draw(LoadAssets.ScalableBox, new Vector2(Bounds.X, Bounds.Y) + hitboxOwner.Level.LevelCam.CameraOffset, null, Color.Red, 0f, Vector2.Zero, new Vector2(Bounds.Width, Bounds.Height), SpriteEffects.None, .999f);
        }
    }
}
