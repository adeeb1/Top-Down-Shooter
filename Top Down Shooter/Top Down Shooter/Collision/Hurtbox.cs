...
namespace Top_Down_Shooter
{
    ...
    public sealed class Hurtbox
    {
        ...
        {
            spriteBatch.Draw(LoadAssets.ScalableBox, new Vector2(Bounds.X, Bounds.Y) - hurtboxOwner.Level.LevelCam.CameraLocation, null, Color.Blue, 0f, Vector2.Zero, new Vector2(Bounds.Width, Bounds.Height), SpriteEffects.None, .999f);
        }
    }
}
